...
car = Entity(model='quad', texture='car', collider='box',
             scale=(2, 1), rotation_z=-90, y=-3)
...
def newEnemy():
    ...
    new = duplicate(car, texture='enemy', x=2*val, y=25,
                    color=color.random_color(), rotation_z=90 if val < 0 else -90)
    enemies.append(new)
